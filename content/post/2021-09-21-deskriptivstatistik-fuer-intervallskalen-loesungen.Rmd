...
Laden Sie die Datensatz ein. Diesen haben Sie bereits aus [<i class="fas fa-download"></i> `fb21.rda`](/post/fb21.rda) heruntergeladen oder den unten aufgeführten direkten Befehl. Die Bedeutung der einzelnen Variablen und ihre Antwortkategorien können Sie weiterhin dem Dokument [Variablenübersicht.pdf](/post/variablen.pdf) entnehmen.
