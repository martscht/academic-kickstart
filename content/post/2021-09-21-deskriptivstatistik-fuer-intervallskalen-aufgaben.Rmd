...
> Laden Sie die Datensatz ein. Diesen haben Sie bereits aus [<i class="fas fa-download"></i> `fb22.rda`](/post/fb22.rda) heruntergeladen. Die Bedeutung der einzelnen Variablen und ihre Antwortkategorien können Sie weiterhin dem Dokument [Variablenübersicht.pdf](/post/variablen.pdf) entnehmen.
