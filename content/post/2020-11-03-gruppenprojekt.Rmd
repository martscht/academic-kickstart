...
lastmod: '2022-11-16T13:50:00+01:00'
featured: no
header:
...
![](/post/aspredicted_datasource.png)
...
Für dieses Praktikum wird vorgegeben, formr zu benutzen. Für eine ausführliche Einführung in formr können Sie sich entweder unser [formr-Tutorial](/post/formr-faq) auf dieser Seite ansehen oder direkt einen Blick auf die [Dokumentation von formr](https://formr.org/documentation) werfen.
...
Wenn nach Open-Science-Prinzipien entsprechend geplant ist, die Daten anschließend anonymisiert für andere öffentlich zur Verfügung zu stellen, muss dies zusätzlich am Ende der Einverständniserklärung innerhalb der Datenschutzklausel erwähnt werden, z. B. wie folgt: 

>Ich bin darüber aufgeklärt worden, dass die hier erhobenen Daten anonymisiert in einem Datenarchiv Dritten zur Verfügung gestellt werden. Daten und Forschungsergebnisse, die bereits auf öffentliche Datenbanken geladen und mit anderen Forschern geteilt wurden, können nicht wieder vollständig gelöscht oder zurückgezogen werden.
...
* Weiterführende Informationen zum Bericht finden Sie [hier](/post/hinweise-zum-ergebnisbericht).
