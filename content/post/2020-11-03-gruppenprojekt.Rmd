...
Vor Beginn der Datenerhebung sollen Sie ihr Forschungsvorhaben auf [AsPredicted](https://aspredicted.org/) präregistrieren. Die Präregistrierung dient dazu,  vor dem Beginn der Datenerhebung die bestehenden Hypothesen sowie das Datenerhebung- und Datenanalysevorhaben niederzulegen.
...
Wenn Sie dem Link folgen werden Sie gebeten alle Autor*innen der Präregistrierung zu nennen. Tragen Sie sich hier selbst ein. Für Ihr Gruppenprojekt in diesem Semester ist es wichtig, dass Sie **auch die Dozentin/den Dozent Ihres Praktikums** hier angeben. Sinn dabei ist, dass wir so die Möglichkeit erhalten Ihre Präregistrierung zu prüfen und Ihnen das finale "Okay" geben können, bevor Sie mit Ihrer Erhebung loslegen. Alle hier gelisteten Autoren bekommen nämlich eine Email zugesandt und können der Präregistrierung entweder zustimmen oder sie ablehnen.

## AsPredicted Questions

Im nächsten Abschnitt finden Sie 9 Fragen, die Ihnen zu Ihrem Projekt gestellt werden. Einen Überblick über die Fragen und ein Beispiel finden Sie z.B. im auf der Seite [direkt verlinkten Blogpost](http://datacolada.org/64). Ein Beispiel von einer Gruppe aus dem PsyBSc 2 Praktikum des letzten Jahres können Sie sich [hier ansehen](/post/aspredicted_example.pdf). Bitte bedenken Sie dabei aber, dass sich die Fragen von AsPredicted ein wenig geändert haben - nutzen Sie das Beispiel also bitte nur als Orientierungshilfe.
...
Für dieses Praktikum wird empfohlen formr zu benutzen. In den kommenden Wochen *sollte* unter https://formr.uni-frankfurt.de eine formr-Variante spezifisch für die Goethe Uni online gehen. Für eine ausführliche Einführung in formr können Sie sich entweder das [6. Projekt](/projects/#project_06) auf dieser Seite ansehen oder direkt einen Blick auf die [Dokumentation von formr](https://formr.org/documentation) werfen.

In Kürze: Für die Erstellung des Fragebogens wird in formr eine Tabelle (z.B. als Google-Doc) angelegt, in der jedes Item in einer Zeile steht. In den verschiedenen Spalten werden die abgebildete Frage, der Fragentyp, die Antwortoptionen und verschiedene weitere Optionen definiert. Als etwas komplizierteres Beispiel können Sie [<i class="fas fa-download"></i>  hier](/post/fb20_questions.ods) die Tabelle der Umfrage aus der ersten Sitzung herunterladen. Die vollständige formr-basierte Umfrage finden Sie [hier](https://psybsc2.formr.org/).
