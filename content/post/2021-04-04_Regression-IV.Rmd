...
`e-17` steht hierbei für $10^{-17}$ also eine Verschiebung des Kommas um 17 Stellen nach links, was eine sehr kleine Zahl ausdrückt. Der Mittelwert ist hier nicht exakt Null, da `R` intern immer auf die sogenannte Maschinengenauigkeit rundet (das sind ca 16 Nachkommastellen). `_centered` steht hierbei für zentriert, also Mittelwert = 0.
...
Auch die 3D-Grafiken sind nicht länger aus "Linien zusammengesetzt", sondern bestehen aus Parabeln/Kurven! 
