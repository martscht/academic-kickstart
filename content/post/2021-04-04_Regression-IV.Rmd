...
knitr::purl("2021-04-04_Regression-IV.Rmd", documentation = 0) #Legt fest das Purl nur die Chunkinhalte(0) in ein R-Skript umwandelt!; NAME DES RMD MUSS EINGESTELLT WERDEN!
file.rename("2021-04-04_Regression-IV.R","PsyBSc7_R_Files/10_reg4.R") #NAME DER R-DATEI MUSS ANGEPASST WERDEN AN RMD-NAMEN!UNTERORDNER SOLLTE MIT KURS ÜBEREINSTIMMEN! (Siehe Ordner in /post)
```
...
```{r exercise_lm_quad-solution, echo=-1}
#### Aufnahme eines quadratischen Effekts ----
...
```{r, fig.align="center", fig.height=6, purl=FALSE}
a <- 1; b <- 0; c <- 0
x <- seq(-2,2,0.01)
f <- a*x^2 + b*x + c
...
```{r, echo = T, fig.align="center", fig.height=6, message=F, warning = F, purl=FALSE}
library(plot3D)
...
## R-Skript
Den gesamten `R`-Code, der in dieser Sitzung genutzt wird, können Sie [`r fontawesome::fa("download")` hier herunterladen](/post/PsyBSc7_R_Files/10_reg4.R).
