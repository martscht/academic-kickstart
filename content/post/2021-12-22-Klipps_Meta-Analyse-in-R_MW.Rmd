...
summary: ''
authors: [irmer]
lastmod: '2022-01-07T15:21:58+02:00'
featured: no
header:
...
## Einführung
Meta-Analysen sind empirische Zusammenfassungen von Studien unter Verwendung mathematischer/statistischer Modelle. Auf diese Weise können Ergebnisse aus jahrelanger Forschung integriert und zusammengefasst werden, was oft Aufschluss darüber liefert, ob Effekte im Mittel vorhanden sind oder nicht. Somit können Meta-Analysen lange Debatten beenden und Licht in das Dunkel von sich widersprechenden Studienergebnissen bringen.
...
Zurückgegeben wird uns ein Datensatz, der um die beiden Variablen `yi` (Standardized Mean Difference) und `vi` (Standardfehler der SMD) erweitert wurde. Hätten wir mehrere Studien übergeben, würden hier entsprechened mehrere Zeilen stehen. Zum Glück liegen die Daten schon vor, sodass wir das nicht für unsere Meta-Analyse tun müssen!
