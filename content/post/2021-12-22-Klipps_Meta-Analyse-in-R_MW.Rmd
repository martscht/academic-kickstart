...
Der Moderator scheint keien signifikanten Heterogenitätsvarianzanteile zu erklären ($Q_M(df=1)=$ `r round(MEM1$QM, 2)`, $p=$, `r round(MEM1$QMp, 4)`). Insgesamt werden nur $1.25\%$ Heterogenitätsvariation durch die Intensität erklärt. Unter 
