...
Due to the highly technical background of <span style="color: darkred;">GitLab</span>, there are many ways to use it. In the three tutorials provided under "Relevantes", you will learn everything you need to know to successfully operate it within the context of research projects. Specifically, in this tutorial, we start with an orientation on the surface/interface.
...
On the other hand, there is also **Explore public projects** here, again self-explanatory. When you click on this, the following page opens:
