...
Zunächst einmal muss <span style="color: darkred;">**Git**</span> auf dem lokalen Rechner installiert werden. Das Programm könnt ihr [hier](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git) herunterladen. Auf dieser Seite gibt es verschiedene Anleitungen für die Installation mit den Softwareprogrammen Windows, macOS und Linux - je nachdem was für ein Betriebssystem ihr verwendet. Besonders bei der Installation auf Windows werdet ihr nach vielen Optionen gefragt. Hier könnt ihr die Voreinstellungen belassen oder auf eure Wünsche anpassen.
