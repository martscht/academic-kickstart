...
### Installation {.tabset .unnumbered}

#### Windows {.unnumbered}

Für Windows findet sich dieInstallationsdatei [hier](https://Git-scm.com/download/win).

Wenn Git installiert ist, kann man den Erfolg nochmal im Terminal testen:

```
git --version
```

Hier wird dann angezeigt, welche Version genutzt wird.
...
Wenn die Installation abgeschlossen ist, kann man durch (erneute) Eingabe den Erfolg testen:

```
git --version
```

Dabei wird auch die verwendete Version angezeigt.
...
Zum Abschluss kann die Installation nochmal getestet werden:

```
git --version
```

Dabei wird auch nochmal die genutzte Version angezeigt.
