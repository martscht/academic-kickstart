...
In diesem Projekt soll es um die Anwendung vom `shiny`-Paket zur Erstellung von interaktiven Websites/Apps gehen. Im Folgenden teilt sich die Problemstellung diesbezüglich in zwei verschiedene inhaltliche Zielsetzungen auf:
...
2. Zum Anderen soll auf der Basis des fünften Projekts eine solche interaktive Oberfläche erstellt werden, dass man ein Sudoku vollständig lösen kann.

Beide Teile können unabhängig voneinander durchgeführt werden und jegliche Anforderungen aus vorhergehenden Projekten werden bereitgestellt. Es ist jedoch empfehlenswert, die Projekte 1 und 5 zuvor selbst probiert und durchgearbeitet zu haben.
