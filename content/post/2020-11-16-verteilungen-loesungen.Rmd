...
Der QQ-Plot zeigt ein ähnliches Muster wie das Histogramm. In der empirischen Verteilung gibt es niedrige Werte, die durch die theoretische Verteilung nicht so zu erwarten wären. Die Werte bleiben demnach unter den Erwartungen - streuen zu weit nach links. Auch auf der rechten Seite bleiben unsere empirischen Werte unter den theoretisch erwarteten zurück (liegen unterhalb der Linie). Hier bedeutet dies, dass unsere empirischen Werte nicht weit genug nach rechts streuen.
