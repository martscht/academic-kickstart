...
Mit "mc_width70" (bzw. 50, ... ,100, 150, 200) kann bei Multiple Choice Items der Abstand zwischen den Auswahlmöglichkeiten eingestellt werden. (Wenn man keine Angabe zum Abstand macht, stehen die Auswahlmöglichkeiten eventuell versetzt unter den Überschriften.) Mit "hide_label mc_width70" (bzw. 50, ... ,100, 150, 200) werden die `labels` der Auswahlmöglichkeiten nicht angezeigt. So werden die Auswahlmöglichkeiten hier nur in der Überschrift angezeigt und nicht auch neben den Auswahlkästchen. Dabei ist es wichtig die Reihenfolge einzuhalten und erst "hide_label" und dann "mc_width70" zu schreiben. Die Überschriften werden mit dem `type` "mc_heading" erstellt.
