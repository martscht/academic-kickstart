...
Die Fragen zum Wiederholungsteil des Quiz sind aus dem bereits im Tutorial bearbeiteten Machiavellismusfragebogen. Sie sind in der Lage, den Datensatz direkt aus dem Internet in ihr Workspace in `R` zu laden. Der funktionierende Befehl sieht so aus:
...
Der Datensatz erhält viele Angaben zur Persönlichkeit und demografischen Daten. An dieser Stelle besprechen wir nur die Variablen, die für das Quiz verwendet werden.  

| Variable | Bedeutung |
| --- | --- |
| `voted` | Teilnahme an der letzten Wahl (1 = Ja, 2 = Nein) |
| `cvhn` | zynische Sichtweise auf die Menschheit |
