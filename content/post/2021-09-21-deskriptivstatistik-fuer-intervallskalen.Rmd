...
<a class="anchor" id="Rekodieren"></a>
## Rekodierung
...
<details><summary>*Quizfrage*: Ist dies eine zulässige Transformation für ordinalskalierte Variablen (wie Items)?  </summary>
...
<details><summary>*Quizfrage*: Was bedeutet `NA` in `fb22$prok_ges`?</summary>
