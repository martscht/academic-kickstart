...
In theory, you also have the option to adjust the *visibility level*. The latter determines who can see the project and all its associated files. There are three options, which are explained below. However, you should always choose the *internal* option as the default. If you do not want your data to be available to the instance, the data folder must remain empty. More information can be found here.
...
![](/post/gitlaborientierung_projektbeschreibung.png)
