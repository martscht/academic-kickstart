...
Eine weitere Möglichkeit wäre, dass READme herunterzuladen auf euren Rechner, dort die Änderungen zu tätigen und anschließend das READme mit Update wieder hochzuladen. 
Ihr müsst bei allen Änderungen immer darauf achten auf dem **main** Branch zu bleiben! 

#### Subgruppen

Jetzt mal zu einem komplett anderen, aber dennoch wichtigem Thema: Subgruppen. 
Durch Subgruppen kann man größere Gruppen organisieren und in interne und externe Organisationen unterteilen. Ihr könnt sogar mehrere Subgruppen unter derselben Elterngruppe haben, da jede Gruppe ihr eigenes Sichtbarkeitslevel hat. 
