...
<!-- Einleitung etwas umformulieren,  ist ja nicht der einzige Ort, wo sie es üben können, sondern eine von uns bereitgestellte Möglichkeit-->
...
<!-- auf jeden Fall die Markdown Dinger nicht über die Gruppe, sondern den eigenen Account erstellen! -->
...
<!-- Hier könnte man auch private nehmen oder siehst du einen Mehrwert für andere Studierende?  -->
...
<!-- Wo sind die Lösungen einsehbar? -->
<!-- Löschen des erstellten Projektes sollte auch nochmal angesprochen werden, müsste mit einer Wartezeit verbunden sein. Bzw. zumindest ansprechen, dass wir es in einem anderen Tutorial mal betrachtet haben. -->
