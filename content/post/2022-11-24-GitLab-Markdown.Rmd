...
<!-- Warum hast du die Lösung nicht auch in einem Markdown Dokument? hab ich versucht, allerdings "übersetzt" GitLab das direkt, wenn man es nur auf dem Server anschaut. -->
...
<!-- Branches waren jetzt im eigene Projekte Teil gar kein Thema mehr - sollte vlt an einer Stelle auch angeschnitten werden -->
...
<!-- Vielleicht doch RMD? wenn dann müsste man sich das halt runterladen, finden manche vllt umständlicher als sich das direkt auf LIFOS anschauen zu können.  -->
...
<!-- Schau nochmal nach, wie lange der Zeitraum ist und wie das wiederherstellen dann gehen würde. Auf GitLab steht folgendes: "The default deletion behavior for projects was changed to delayed project deletion in GitLab 12.6, and then to immediate deletion in GitLab 13.2." -->
