...
Wie ihr in den Grundlagen für LIFOS bereits gesehen habt, ist zumindest ein Bestandteil eures Projekts in Markdown Code geschrieben - das README. [Hier](/content/post/lifos-eigenesProjekt/#Markdown) haben wir bereits die wichtigsten Informationen über Markdown aufgeführt, damit ihr euer eigenes README angemessen gestalten wird. Wir wollen euch aber nochmal zusätzlich eine Übungsmöglichkeit für Markdown bieten, indem ihr in einem Projekt auf LIFOS ein Dokument nachbauen soll. Im Folgenden werden dafür alle wichtigen Schritte beschrieben. 
