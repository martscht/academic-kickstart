...
<!-- Das wird ja durch eine Einstellung später gewährleistet, auch mit diesem Klick könnte man ein Project in einer Gruppe erstellen -->
...
Das Visibility Level für dieses Projekt könnt ihr auf *Private* stellen. Damit ist es nur für euch sichtbar, aber da es hier nur um die Übung geht, ist das kein Problem. Visibility Level haben wir [hier](#) schonmal erklärt.

<!-- Link einfügen zu eigenes Projekt, nachdem wir visibility erklärt haben -->
...
<!-- Warum hast du die Lösung nicht auch in einem Markdown Dokument? -->
...
Jetzt müsstet ihr eine Meldung bekommen, dass das Projekt im "pending deletion" Status ist. Dieser Status ist nochmal ein Sicherheitscheck, der nach dem Löschen einen Zeitraum gibt, in dem ein Projekt wiederhergestellt werden kann. In dieser Zeit kann niemand außer den Projektangehörigen mehr das Projekt sehen. 

<!-- Schau nochmal nach, wie lange der Zeitraum ist und wie das wiederherstellen dann gehen würde -->
