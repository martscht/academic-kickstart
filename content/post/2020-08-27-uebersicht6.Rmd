...
In Zukunft wirst du dich auch mit deinem HRZ-Account bei FormR anmelden können, da es einen Server an der Goethe Universität geben wird. Weitere Informationen dazu werden folgen, sobald es so weit ist.
