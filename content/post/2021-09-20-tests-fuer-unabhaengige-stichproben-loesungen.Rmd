...
Es wurde untersucht, ob außerhalb von Frankfurt wohnende Studierende zufriedener im Leben sind als die in Frankfurt wohnenden. Deskriptiv  zeigt sich tatsächlich, dass die Nicht-Frankfurter zufriedener sind (_Mdn_ = 5.2, _IQB_ = [4.6; 5.6]) als die Frankfurter (_Mdn_ = 5, _IQB_ = [4.0; 5.8]). entsprechende Wilcoxon-Test zeigt jedoch ein nicht signifikantes Ergebnis (_W_ = 1512.5, _p_ = .501). Die Nullhypothese konnte nicht verworfen werden und wird beibehalten. Die Studierenden sind gleich zufrieden, unabhängig von deren Wohnort.
