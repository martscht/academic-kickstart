...
Zunächst einmal muss ein Ordner erstellt werden, in den das Projekt geladen werden soll. Das geht einfach über die Ordneransicht oder in der Konsole. Wir legen den Ordner `dummy` in unseren Statistik-Ordner im Studium ab. Anschließend müssen wir in den Ordner wechseln.
...
Damit ihr diesen Ordner wieder mit `git` verknüpfen könnt, müsst ihr
