...
Wenn stattdessen eine Fehlermeldung angezeigt wird, sollte der folgende Befehl stattdessen helfen:

```
git push -u origin main
```

Im Terminal wird man nach dem User-Name und Passwort von <span style="color: darkred;">**GitHub**</span> gefragt, wodurch sicher gestellt wird, dass niemand Fremdes einfach ein Repository mit seinen Dateien überschreibt. <span style="color: darkred;">**Git**</span> hat hier zur zusätzlichen Sicherheit die Personal Access Tokens eingeführt. Das ist vor allem praktisch, wenn ihr <span style="color: darkred;">**Git**</span> an unterschiedlichen Geräten benutzt. Wie ihr es erstellen könnt, steht hier:

### Personal Access Token {#personalaccesstoken}

Wie bereits oben erwähnt, braucht man den PAT, wenn man selbst an unterschiedlichen Geräten mit <span style="color: darkred;">**SmartGit**</span> arbeitet. Das besondere an diesem Token ist, dass es an einen Nutzer gebunden ist. Das heißt, es wird diesselben Zugriffsrechte wie der User haben (bei Zugriff auf Content oder Spaces). Um eines zu erstellen, müsst ihr euch erstmal auf <span style="color: darkred;">**GitHub**</span> einloggen. Dann navigiert ihr zu **Settings** und klickt in der linken Spalte ganz unten **Developer Settings** an. Hier geht ihr dann auf **Personal Access Token** und generiert ein neues Token. 
