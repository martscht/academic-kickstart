...
Um das Projekt jetzt von `GitHub` auf euren Rechner zu laden, benötigt ihr wieder die URL des Projekts. Diese kann man kopieren, indem man auf den grünen Button *code* in der Übersicht des Respositorys klickt und anschließend auf das kleine Clipboard neben dem angezeigten Link. 
