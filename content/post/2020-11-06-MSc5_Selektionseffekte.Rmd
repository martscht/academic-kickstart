...
[Briggs, D. C. (2004). Causal inference and the Heckman model.](https://hds.hebis.de/ubffm/EBSCO/Record?id=ED478203|eric) *Journal of Educational and Behavioral Statistics, 29*(4), 397--420.

[Heckman, J. (1979). Sample selection bias as a specification error.](https://hds.hebis.de/ubffm/EBSCO/Record?id=edsjsr.10.2307.1912352|edsjsr) *Econometrica*, 47, 153–161.

[Toomet, O., & Henningsen, A. (2008). Sample selection models in R: Package sampleSelection.](https://hds.hebis.de/ubffm/EBSCO/Record?id=edsbas.C30BA3A7|edsbas) *Journal of Statistical Software, 27*(7), 1-23.
