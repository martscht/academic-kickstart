...
round(cov(Therapy[Therapy$Intervention == "VT Coaching + Gruppenuebung", 1:4]), digits = 2)
...
qqPlot(MD, distribution = "chisq", df = 4) #QQ-Plot
...
### Appendix B: MANOVA (und ANOVA) mit Messwiederholung
