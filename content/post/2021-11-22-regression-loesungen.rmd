...
Wenn sich die Variable `gewis` um eine Standardabweichung verändert, verändert sich das Kriterium `lz` um `r round(sfmg$coefficients[2], 2)` Standardabweichungen.
</details>
...
sum_fmn <- summary(fmn)
```
  * Das Modell erklärt `r round(sum_fmn$adj.r.squared*100, 2)`% der Varianz in Lebenszufriedenheit durch Neurotizismus.
</details>
