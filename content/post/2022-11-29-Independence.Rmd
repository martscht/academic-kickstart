...
If you still have questions about loading your data into `R` or if you're still unsure on how the working directory works, have a look at the [R crash course](/post/r-crash-kurs) on `pandaR`, where all these topics are discussed in more detail.
