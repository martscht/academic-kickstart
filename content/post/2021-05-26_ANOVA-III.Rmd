...
knitr::purl("2021-05-26_ANOVA-III.Rmd", documentation = 0) #Legt fest das Purl nur die Chunkinhalte(0) in ein R-Skript umwandelt!; NAME DES RMD MUSS EINGESTELLT WERDEN!
file.rename("2021-05-26_ANOVA-III.R","PsyBSc7_R_Files/09_anova3.R") #NAME DER R-DATEI MUSS ANGEPASST WERDEN AN RMD-NAMEN!UNTERORDNER SOLLTE MIT KURS ÜBEREINSTIMMEN! (Siehe Ordner in /post)
```
...
Dies kann man leicht prüfen: $-1*1 + 0*-2 + 1*1 = 0$ (hier ist die erste Zahl pro Summand jeweils der Koeffizient des ersten Kontrasts und die zweite jeweils die vom zweiten: (-1, 0, 1) und (1, -2, 1)).
...
```{r, warning=F, message=F, purl=FALSE}
...
## R-Skript
Den gesamten `R`-Code, der in dieser Sitzung genutzt wird, können Sie [`r fontawesome::fa("download")`hier herunterladen](/post/PsyBSc7_R_Files/09_anova3.R).
