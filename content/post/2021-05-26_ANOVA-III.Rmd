...
summary: ''
authors: [scheppa-lahyani,schultze]
lastmod: '2021-05-26T08:32:21+02:00'
featured: no
header:
...
Wie schon für die Kontraste in der [letzten Sitzung](/post/zweifaktorielle-anova/) wird hierbei die Nullhypothese getestet, dass $H_0 : -1 \cdot \mu_1 + 0 \cdot \mu_2 + 1 \cdot \mu_3 = 0$. Im Fall von drei Wiederholungen ist der lineare Trend also einfach die **Differenz zwischen 1. und 3. Messung**.
...
Wie Sie erkennen können, ist nur der lineare Kontrast signifikant! Signifikant bedeutet hier, dass der Kontrast verworfen wird, wir nehmen also an, dass es einen quadratischen Trend in den Daten gibt, bzw. liefert uns die inferenzstatistische Testung keinen Grund dafür an dieser Annahme zu zweifeln. Dieses Vorgehen ist etwas anders als ein normaler Signifikanztest, da wir nur den jeweiligen Trend verwerfen und nicht annehmen können! 
...
Es zeigt sich in diesem Fall also ein bedeutsamer linearer, aber kein bedeutsamer quadratischer Trend. Dies bedeutet also, dass der lineare Trend verworfen werden muss, der quadratische jedoch nicht! Wie schon zuvor, können wir hier mit `adjust` eine Bonferroni-Korrektur vornehmen:
...
Hier erkennt man, dass sich vor allem Unterschiede zwischen 14 und 15 Jahren sowie zwischen 14 und 16 Jahren ergeben. 
...
Der Vergleich mit dem Mittel ist dann nützlich, wenn man sehr viele Zeitpunkte (oder Gruppen) hat. Dann bietet es sich an zu prüfen, ob es spezifische Instanzen gibt, die *"auffällig"* vom Durchschnittswert abweichen, statt sehr viele Einzelvergleiche zu definieren. Dies gilt besonders dann, wenn man keine natürliche Referenzkategorie hat - wie z.B. einen Prätest oder eine Kontrollgruppe. In unserem Fall weichen das Alter 14 und 16 von Mittel ab.
