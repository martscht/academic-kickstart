...
<!-- Dazu bitte auch eine Grafik erstellen - vlt auch mit einem Entwicklungs- und einem Dokumentations Branch -->

### Wie speichert <span style="color: darkred;">**Git**</span> Daten? `
...
Dafür gebt ihr im Terminal den Befehl `git log` ein. 

<!-- Das folgende Bild wirkt nicht so, als ob es hierhin gehört -->
...
<!-- Die Checksums finden bei den Branches ja eigentlich gar keine Erwähnung mehr - vielleicht gehört das doch fast alles eher in den Appendix, um das ganze nochmal technischer zu erklären? -->
...
Bild 1: 
![](/post/branches_UnterschiedBranches3.jpg)
Bild 2: 
![](/post/branches_UnterschiedBranches4.jpg)
<!-- Von der Makierung her bist du doch bei beiden Bildern auf dem master Branch? -->
...
<!-- Der hier genannte New Branch wäre jetzt eher der Analyse1 Branch oder? -->
...
<!-- Das heißt, es wäre nur kein Konflikt, wenn man nur neue Dateien auf dem neuen Branch erstellt? Ja, genau. Wenn man die Datei auf einem Branch ändert, also z.B. eine Zeile hinzufügt, dann ist das ein Konflikt. -->
