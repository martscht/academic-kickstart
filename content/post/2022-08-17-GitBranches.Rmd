...
<!-- Kannst du hier dem Testbranch noch einen zweiten Commit geben - damit auch klar wird, was der Mehrwert gegenüber einfachem reverten wird. -->

![](/post/branches_MergeGraphic.png)

<!-- Vielleicht noch ein zweites Anwendungsbeispiel - Speicherung des Standes zum Zeitpunkt der Abgabe von einer ersten Version oder sowas, Branch dann frozen nennen und dieser ändert sich nicht mehr. Dadurch wird auch nochmal deutlich, dass es mehr als zwei Branches geben kann -->
...
<!-- Kannst du hier auch nochmal die Eingabe im terminal mit ins Bild holen? -->
...
<!-- Sieht irgendwie so aus, als ob bei Smartgit einfach nicht alles der Sum angezeigt wird? Gibt es dazu Informationen? Also ich finde es nicht eine andere "Sprache", sondern nur eine abgehackte Darstellung-->
...
<!-- Den Pfeil an der Seite finde ich etwas undeutlich über seine Bedeutung -->

![](/post/branches_GitDatenStruktur.png)

<!-- Ich frage mich, ob das ganze über checksums und blobs nicht an sich in die vertiefenden Informationen könnte? Weil später gibt es dazu ja nicht wirklichen Bezug oder? -->
...
<!-- Auch hier den Befehl mit in den Screenshot -->
...
<!-- Einfach der Dateiexplorer - also wenn man sie ganz klassisch auf seinem Computer öffnet -->
...
<!-- Kann es sein, dass du neuer Commit nicht auf GitHub gepushed hattest? Die Zahlen in den Abbildungen neben dem master branch finde ich verwirrend -->
...
<!-- Das heißt, es wäre nur kein Konflikt, wenn man nur neue Dateien auf dem neuen Branch erstellt? -->
...
<!-- Woran sehe ich in dieser Abbildung den erfolgreichen Merge? -->

<!-- Können wir noch den zweiten, unnützen zwei löschen? -->
