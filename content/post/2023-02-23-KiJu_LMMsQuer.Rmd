...
```{r}
mod1 <- lmer(lezu ~ 1 + pa + (1 | nation), kultur)
print(summ(mod1))
```
...
```
```{r, echo = FALSE}
load(url('https://pandar.netlify.app/post/KiJu_LMMs_confint3.rda'))
print(ci_mod3)
```
...
names(cwc) <- c('nation', 'pa_cwc', 'na_cwc')
