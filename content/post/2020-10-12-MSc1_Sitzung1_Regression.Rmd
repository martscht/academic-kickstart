...
```
Fasst noch einmal zusammen, welches Objekt "zusammengefasst" wird. Es fällt auf, dass das Interzept in der Zusammenfassung nicht erneut auftaucht, da es per Default mitgeschätzt wird. 
