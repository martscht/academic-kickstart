...
lastmod: '2022-22-11T19:07:56+01:00'
featured: no
header:
...
Alternativ können Sie die fertige R-Datei [<i class="fas fa-download"></i> hier herunterladen](/post/fb22.rda). Die Bedeutung der einzelnen Variablen und ihre Antwortkategorien können Sie dem Dokument [Variablenübersicht.docx](/post/variablen.pdf) entnehmen.
