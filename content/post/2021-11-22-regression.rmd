...
* b0 (Regressionsgewicht): beträgt die Extraversion 0, wird eine Nerdiness von 4.38 vorhergesagt  
* b1 (Regressionsgewicht): mit jeder Steigerung der Extraversion um 1 Einheit wird eine um 0.37 Einheiten niedrigere (!) Nerdiness vorhergesagt
...
15,8% der Varianz von `nerd` können durch `extra` erklärt werden. Dieser Effekt ist nach Cohens (1988) Konvention als mittelstark zu bewerten.
...
Entsprechend ist das Quadrat der Korrelation identisch zum Determinationskoeffizienten des Modells mit standaradisierten Variablen...
```{r}
