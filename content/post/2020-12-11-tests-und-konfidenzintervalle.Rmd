...
Da die Varianz in der Population nicht bekannt ist, muss diese mittels Nutzung Varianz der Stichprobe geschätzt werden. Dies funktioniert über die Funktion `sd`.
