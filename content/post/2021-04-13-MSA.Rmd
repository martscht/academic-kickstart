...
fit_pfad_moderiert <- sem(model_pfad_moderiert, StressAtWork)
```

Als Ergebnis dieser moderierten Regression ergibt sich dann:
...
```{r}
print("Insert graphic here !!!!!")
```

Abgetragen sehen wir auch die Gruppenunterschiede.
