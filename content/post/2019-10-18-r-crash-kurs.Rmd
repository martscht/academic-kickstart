...
summary: ''
authors: [schultze]
lastmod: '2019-10-18T11:35:06+02:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
<!-- Der Fragebogen, den Sie letzte Woche ausgefüllt haben liegt im CSV Format vor und heißt **fb19.csv**. Mit `read.table` können wir diesen Datensatz laden, müssen aber bestimmte Eigenheiten des Datensatzes bedenken. Wenn Sie den Datensatz mit einem Text-Editor öffnen sehen die ersten 5 Zeilen folgendermaßen aus: -->

<!-- ```{r, echo = FALSE} -->
<!-- cat(paste(readLines('./fb19.csv')[1:5], collapse = '\n')) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- fb19 <- read.table('fb19.csv', header = TRUE) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- fb19 <- read.table('fb19.csv', header = TRUE, sep = ",") -->
<!-- ``` -->

<!-- Im Environment erscheint jetzt das Objekt `fb19`. Mit `head` können wir uns den Kopf des Datensatzes (die ersten 6 Zeilen) anzeigen lassen: -->

<!-- ```{r} -->
<!-- head(fb19)    # Kopfzeilen -->
<!-- str(fb19)     # Struktur des Datensatzes -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- write.table(fb19,     # zu speichernder Datensatz -->
<!--   'fb19.txt'          # Dateiname -->
<!--   ) -->
<!-- ``` -->
...
<!-- ```{r, echo = FALSE} -->
<!-- cat(paste(readLines('fb19.txt')[1:5], collapse = '\n')) -->
<!-- ``` -->
