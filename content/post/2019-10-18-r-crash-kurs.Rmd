...
Damit etwas passiert, muss die Syntax mit **Strg+Return** (OS X: **cmd+Return**) oder mit dem <img src="/post/2019-10-18-r-crash-kurs_files/run.png" style="display: inline-block; margin: 0" />  Button ausgeführt werden. Wenn Sie z.B. `3 + 4` in die Syntax schreiben und so ausführen, erscheint in der Konsole:
