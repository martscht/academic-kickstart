...
Der Code aus Aufgabe 1 ist aktuell nur auf die Überprüfung einer Zahl bei einem bestimmten Einsatz spezialisiert. Für jede andere Wette und/ oder jeden anderen Einsatz müsste ein neuer Code geschrieben werden. 
...
Erstelle dann wieder eine Schleife mit 50 Spielen, die unter Verwendung des gerade erstellten Codes jeweils die Zufallsziehung und den Gewinn abspeichert und teste dein "`R`-Roulette", indem du auf `ODD` tippst.
