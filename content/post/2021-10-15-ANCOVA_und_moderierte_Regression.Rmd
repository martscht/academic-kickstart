...
Der zentrierte Fall ist auf 14 Nachkommastellen identisch und weicht danach nur wegen der sogenannten Maschinengenauigkeit voneinander ab. Somit ist klar, dass wenn der Mittelwert = 0 ist, auch die Korrelation zwischen einer Variable und seinem Quadrat = 0 ist. Analoge Überlegungen können genutzt werden, um das Gleiche für die Interaktion von Variablen zu sagen.
