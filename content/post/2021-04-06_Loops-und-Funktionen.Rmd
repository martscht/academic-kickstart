...
options(knitr.duplicate.label = "allow") #Muss gesetzt werden
options(knitr.purl.inline = FALSE) #Inline-Code wird ins Skript übernommen (TRUE) oder ausgelassen (FALSE)
knitr::purl("2021-04-06_Wiederholung-von-Grundlagen.Rmd", documentation = 0) #Legt fest das Purl nur die Chunkinhalte(0) in ein R-Skript umwandelt!; NAME DES RMD MUSS EINGESTELLT WERDEN!
file.rename("2021-04-06_Wiederholung-von-Grundlagen.R","PsyBsc7_R_Files/01_Wiederholung-von-Grundlagen.R") #NAME DER R-DATEI MUSS ANGEPASST WERDEN AN RMD-NAMEN!UNTERORDNER SOLLTE MIT KURS ÜBEREINSTIMMEN!
```

```{r Info, purl=TRUE, echo=FALSE}
# ---- Loops und Funktionen ----
#Dieses Skript stammt von https://pandar.netlify.app/post/PsyBsc7_R_Files/01_Wiederholung.R, von der PandaR-Website der Goethe Universität Frankfurt.
