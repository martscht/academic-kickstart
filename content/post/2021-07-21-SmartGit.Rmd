...
<!-- Terminal Befehler hierzu-->

##### `git revert`

Mit dem Befehl `git revert HEAD` wird ein neuer `Commit` erstellt, der den vorherigen reverted. Wenn ihr `git log` ausführt, werdet ihr eueren ungewollten `Commit` zwar noch sehen, aber inhaltlich ist dieser rückgängig gemacht worden. In unserer Datenauswertung haben wir jetzt etwas Falsches reingeschrieben. 
...
<!-- Hier sollte man nochmal genauer erklären, was passiert, vielleicht auch Bilder dazu erstellen-->
<!-- SmartGit Befehle hierzu-->
...
<!-- Auch nochmal mehr mit Bildern arbeiten?-->
...
<!-- Kann man diese Erklärung noch spezifizieren?-->
...
<!-- Würde die Reihenfolge tauschen, erst auf GitHub die Änderung machen un dann lokal ändern und versuchen, zu pushen, weniger hin und her -->
...
<!-- Bzw. erstellst du hier jetzt nicht einen Konflikt, durch zwei Pushs. Das widerspricht sich dann etwas mit der Einleitung -->
...
<!-- Nicht das Wort Entwickler benutzen - sind ja im psychologischen Kontext, könnte abschrecken -->
