...
Entweder ihr generiert einen Personal Access Token (PAT), wenn ihr <span style="color: darkred;">**SmartGit**</span> öfter auf unterschiedlichen Geräten benutzt oder ihr generiert einen Application Programming Interface (API) Token, der mehr Sinn macht, wenn ihr mehrere Provider habt wie <span style="color: darkred;">**GitHub**</span>, von denen ihr aus <span style="color: darkred;">**SmartGit**</span> aus zugreifen wollt. 
...
<!-- Habe geschaut, dass Git Tutorial hat von Anfang an nur Praktikum. Oder ich habe was überlesen -->
