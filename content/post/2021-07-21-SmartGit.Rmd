...
1. `git checkout --<Datei>`: ist genau dasselbe wie **Discard** in <span style="color: darkred;">**SmartGit**</span>. Eure Änderungen werden permanent gelöscht und ihr kehrt wieder auf den Stand des letzten `commit` zurück. 
 ...
 <!-- nochmal checken - erscheint etwas komisch  -->
...
<!-- Wo genau findet man dieses Log? -->
...
<!-- Was wäre hier der Unterschied zu revert? nicht geloggt? -->
...
<!-- Was genau macht stage dann hier und was würde passieren, wenn man dont stage klickt? -->
