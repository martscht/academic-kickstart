...
1. Erstellt eine neue Datei in R, die ihr dann committed und auf <span style="color: darkred;">**GitHub**</span> pushed, sodass ihr lokal und remote denselben Stand habt. Natürlich könnt ihr auch eine schon bestehende Datei nehmen. Wichtig ist nur, dass ihr lokal und auf <span style="color: darkred;">**GitHub**</span> denselben Stand habt.

2. Geht auf <span style="color: darkred;">**GitHub**</span> und ändert etwas an der Datei (hier in Zeile 20) und speichert diese Änderungen. Die Person, die remote arbeitet, will einen `shapiro.test()` machen. 

![](/post/smartgit_GitHub_Änderungen.png)
3. Jetzt ändert ihr lokal etwas in der Datei (auch in Zeile 20). Die "lokale" Person will einen `t.test()` mit den Daten ausführen. 

![](/post/smartgit_KonfliktLokal2.png)
4. Öffnet <span style="color: darkred;">**SmartGit**</span> und führt nur einen `Commit` durch, danach nicht wie normalerweise noch einen `Push`. 


![](/post/smartgit_KonfliktCommit.png)
5. Versucht einen *Push* durchzuführen. Es müsste euch folgende Warnung angezeigt werden: 
