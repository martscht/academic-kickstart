...
1. `git checkout --<Datei>`: ist genau dasselbe wie **Discard** in <span style="color: darkred;">**SmartGit**</span>. Eure Änderungen werden permanent gelöscht und ihr kehrt wieder auf den Stand des letzten `commit` zurück. 
...
Dieser Befehl ist eine sichere Method, um einen `Commit` rückgängig zu machen. 
Was genau passiert, werdet ihr in folgendem Beispiel sehen. 

In unserer Datenauswertung haben wir jetzt etwas Falsches reingeschrieben:
