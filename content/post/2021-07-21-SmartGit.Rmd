...
2. Jetzt ändert ihr lokal etwas in der Datei (hier in Zeile 2).

![](/post/smartgit_KonfliktLokal.png)
...
4. Wechselt nun zu <span style="color: darkred;">**GitHub**</span>  und ändert dort etwas in derselben Zeile, in der ihr auch lokal etwas verändert habt (hier also Zeile 2). Jetzt speichert ihr diese Änderungen.  
...
![](/post/smartgit_ConflictSolver2.png)
...
Wir wollen jetzt die 2. Zeile der rechten Seite ("Hier Konflikt") und die 4. Zeile der linken Seite ("Oder doch?") behalten.
Das heißt wir nehmen die linke Seite (*Take Left*) mit einer kleinen Modifikation. Um jetzt die 2. Zeile der rechten Seite einzufügen, geht man mit Rechtsklick auf diese Zeile und klickt dann auf *Apply Inner line Difference to Middle*. 

![](/post/smartgit_KonfliktLösung.png)
