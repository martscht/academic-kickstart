...
Entweder ihr generiert einen Personal Access Token (PAT), wie man das machen kann, haben wir euch schon im Tutorial zu [GitHub](https://pandar.netlify.app/post/github/#personal-access-token) gezeigt oder ihr generiert einen Application Programming Interface (API) Token, der mehr Sinn macht, wenn ihr mehrere Provider habt wie <span style="color: darkred;">**GitHub**</span>, von denen ihr aus <span style="color: darkred;">**SmartGit**</span> aus zugreifen wollt.  

Nachdem ihr also euer PAT eingegeben habt als Passwort, wurde der `push` durchgeführt. Um einen optischen Indikator dafür zu haben, könnt ihr euer Repository auf der <span style="color: darkred;">**GitHub**</span>-Website öffnen. Weiterhin sind man auch in der Kachel **Journal**, dass **_origin_** und **_main_** nun wieder auf derselben Höhe des neuen `commits` sind.
