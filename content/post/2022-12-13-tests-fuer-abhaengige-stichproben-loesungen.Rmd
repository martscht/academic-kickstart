...
Die Skala "Prokrastination" soll bei hohen Werten eine höhere Prokrastinationstendenz darstellen. Um zu vergleichen, ob die Zustimmung je nach Itemformulierung (pos. vs. neg.) anders ausfällt, müssen wir die negativ formulierten Items zunächst rekodieren (wurde im Seminar bereits durchgeführt).
