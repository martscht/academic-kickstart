...
lastmod: '2022-11-01T20:54:18+02:00'
projects: []
...
Nachdem wir in der letzten Sitzung die Arbeit mit dem CSV Format kennen gelernt haben, nutzen wir jetzt die Datei im RDA Format für das Einlesen des Datensatzes. Die Datei können Sie [hier <i class="fas fa-download"></i> herunterladen](/post/fb22.rda). Sie können ihn aber alternativ auch mit dem folgenden Befehl direkt aus dem Internet einladen. Außerdem ist es prinzipiell ratsam, zu Beginn wieder das Arbeitsverzeichnis mit Hilfe von `setwd()` zu bestimmen.
