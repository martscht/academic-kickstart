...
Es gibt noch zwei weitere Sonderfälle in unserem Datensatz. Das sind die ausgeschlossenen Medien, oder wenn jemand dem Chat beigetreten bzw. ihn verlassen hat. Zweiteres kannst du wie bei den Absätzen verändern, nur dass hier nichts rein kopiert werden soll, sondern die ganze Zeile gelöscht wird. <br/>
...
Dazu gibt es verschiede Möglichkeiten: Wir können mit den Basicfunktionen von R oder mit `ggplot` arbeiten.
