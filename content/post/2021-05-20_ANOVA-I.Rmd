...
Die praktische Arbeit soll anhand des Datensatzes `conspiracy` demonstriert werden, den wir also zunächst in unserem Environment haben müssen.

### Daten laden
Wenn Sie den Datensatz lokal auf ihrem Rechner haben möchten, können Sie ihn  [`r fontawesome::fa("download")` Datensatz "conspiracy.rda" hier herunterladen](https://pandar.netlify.app/post/conspiracy.rda). Anschließend muss er eingeladen werden - natürlich mit Ihrem Dateipfad.
...
Der Datensatz enthält die Werte von 2451 Personen auf 9 Variablen und 
