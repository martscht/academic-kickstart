...
> Laden Sie die Daten aus [<i class="fas fa-download"></i> `fb21.rda`](/post/fb21.rda). Die Bedeutung der einzelnen Variablen und ihre Antwortkategorien können Sie dem Dokument [Variablenübersicht.pdf](/post/variablen.pdf) entnehmen.
