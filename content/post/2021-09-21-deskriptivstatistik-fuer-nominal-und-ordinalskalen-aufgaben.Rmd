...
> Laden Sie die Daten aus [<i class="fas fa-download"></i> `fb22.rda`](/post/fb22.rda) oder direkt von der Website über die gelernten Befehle. Die Bedeutung der einzelnen Variablen und ihre Antwortkategorien können Sie dem Dokument [Variablenübersicht.pdf](/post/variablen.pdf) entnehmen.
