...
Alternativ können Sie die fertige R-Daten-Datei [<i class="fas fa-download"></i> hier herunterladen](/post/fb21.rda). Die Bedeutung der einzelnen Variablen und ihre Antwortkategorien können Sie dem Dokument [Variablen?bersicht.docx](/post/variablen.pdf) entnehmen.
...
Mit einer Irrtumswahrscheinlichkeit von 5% wird die $H_0$ (keine Veraenderung) verworfen. Die Abschlussnote hat sich über die Jahre verbessert.
...
Das 95%-ige Konfidenzintervall liegt zwischen 3.22 und 3.49. Das bedeutet, dass in 95% der Fälle in einer wiederholten Ziehung aus der Grundgesamtheit die mittleren Verträglichkeitswerte zwischen 3.22 und 3.49 liegen.
...
Die Effektgröße ist als klein einzuordnen.
...
Die Effektgröße ist als klein bis mittel einzuordnen.
...
Das 95%-ige Konfidenzintervall liegt zwischen 4.09 und Inf (Ausserhalb des definierten Wertebereichs). Das bedeutet, dass in 95% der Fälle in einer wiederholten Ziehung aus der Grundgesamtheit die mittleren Verträglichkeitswerte zwischen 4.09 und Inf (Ausserhalb des definierten Wertebereichs) liegen.
...
Die Effektgröße ist als mittel bis hoch einzuordnen.
