...
lastmod: '2022-22-11T19:09:16+01:00'
featured: no
header:
...
Laden Sie zunächst den Datensatz `fb22` von der pandar-Website.

```{r}
load(url('https://pandar.netlify.app/post/fb22.rda'))
```

Alternativ können Sie die fertige R-Daten-Datei [<i class="fas fa-download"></i> hier herunterladen](/post/fb22.rda). Die Bedeutung der einzelnen Variablen und ihre Antwortkategorien können Sie dem Dokument [Variablenübersicht.docx](/post/variablen.pdf) entnehmen.
