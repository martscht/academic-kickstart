...
Dieser Schritt ist sehr wichtig, da das Projekt auf jeden Fall zur richtigen Abteilung zugeordnet werden sollte! Falls ihr noch nicht der Gruppe eurer Abteilung angehört, lest nochmal im [Tutorial zur Orientierung](/post/lifos-orientierung) nach.
...
Wenn ihr diese Option auswählt, können nur die Mitglieder der Gruppe, der das Projekt zugeordnet ist, auf dieses zugreifen. 
...
<!-- Vielleicht hier nochmal Beispiele geben, was gute Commit-Messages ausmachen? -->
...
Falls ihr eine Datei direkt in einem Ordner erstellen wollt, müsst ihr den gwünschten Ordner öffnen und dann diesselbe Prozedur, wie oben wiederholen, durchführen. 
...
<!-- Hier könnte ein Link zur Verbindung mit Smartgit schonmal angestellt werden, wo das ja möglich wäre - und auch nochmal darauf verwiesen, dass das Tutorial trotzdem erstmal gelesen werden sollte, vor der Verbindung-->
...
<!-- Und diese Warnmeldung kann man nicht umgehen bzw. ignorieren?? Dann müssten sie ja immer die Datei erst löschen und dann neu hochladen? -->
...
<!-- Das hast du ja schonmal erwähnt, weiter oben. Vielleicht hier nochmal aufzeigen, dass es das ist, was beim runterscrollen angezeigt wird?-->
...
<!-- Vielleicht nochmal aufzeigen, wo man sich jetzt die alte Version nochmal anzeigen lassen könnte? -->
<!-- WEB-IDE funktioniert aber nur mit Markdown, R etc. und nicht mit Word oder? -->
...
<!-- Hast du auch versucht, die alte Version zu öffnen? -->
##### Dateien löschen
...
<!-- Beschreiben, wo diese Datei herkommt -->
...
<!-- Dafür muss doch erstmal der Ordner angesteuert werden oder? -->
...
<!-- Muss man gar nichts mehr drücken danach? Heißt die gitkeep Datei ist verantwortlich für den Erhalt des Ordners? Oder geht es auch bei jeder anderen Datei? -->
...
Wenn ihr eine Übung zum Erstellen eines Dokumentes mit Markdown durchführen wollt, findet ihr [hier](https://pandar.netlify.app/post/lifos-r-markdown-uebung/) dazu eine Anleitung.



### Fazit  

Dieses Tutorial hat euch erklärt wie ihr ein Projekt erstellen könnt, sowie Dateien und Ordner in diesem bearbeiten könnt. Ihr habt aber bestimmt selbst gemerkt, dass es noch viele andere verschiedenen Funktionen und Möglichkeiten gibt mit <span style="color: darkred;">**GitLab**</span> und dem LIFOS-Server zu arbeiten. Außerdem habt ihr die Basics von Markdown gelernt. 
<!-- Hier würde ich dann vor allem eine Verlinkung zu dem SmartGit Teil erstellen und evtl. noch zu der vertiefenden Einführung in die Übersicht -->
