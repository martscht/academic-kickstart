...
Nachdem ihr das Template ausgewählt habt, das auf euer Vorhaben am besten zutrifft, müsst ihr diesem einen Namen geben und ihr hättet theoretisch die Möglichkeit das *Visibility-Level* anzupassen. Durch Letzteres wird festgelegt, wer das Projekt und alle zugehörigen Dateien sehen kann. Hier gibt es drei Optionen, die erklärt werden. Aber ihr wählt als Standard-Option grundsätzlich immer *internal*. Wenn eure Daten der Instanz nicht zur Verfügung stehen sollen, muss der Datenordner leer bleiben, genaueres könnt ihr [hier](#) nachlesen. 
...
<!-- Und diese Warnmeldung kann man nicht umgehen bzw. ignorieren?? Dann müssten sie ja immer die Datei erst löschen und dann neu hochladen? Ja, die kann man nicht umgehen.-->
...
<!--  Kann ich auch bei Word-Dateien auf die alte Version zugreifen? Nein, kann man nicht!! außer das ist getracked. --> 
