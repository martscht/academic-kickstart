...
Nachdem ihr sowohl schon die Basics über LIFOS und <span style="color: darkred;">**GitLab**</span> erfahren habt und auch euer richtiges Template ausgewählt habt, ist es jetzt an der Zeit, dass ihr euer erstes eigenes Projekt erstellt. **Es ist hierbei äußerst wichtig, dass, sofern Ihr eine Abschlussarbeit durchführen wollt, Ihr bereits in der entsprechenden [Gruppe](/post/lifos-orientierung/#gruppen) der Abteilung seit bevor ihr euer Projekt erstellt!**
...
Falls ihr sehr vertrauliche Daten habt, und zweifelt, ob diese Option die richtige ist, schaut hier<!-- WIP --> nach. Dort wird erklärt, was ihr tun solltet, falls dieser Fall auf euch zutreffen sollte. 
