...
<!-- Man kann ja auch einfach den normalen Weg gehen zur Projekterstellung gehen und da die Gruppe auswählen - ist vielleicht intuitiver! und es ist auch besser zu verallgemeinern, wenn mal jemand ein Projekt für sich selbst erstellen will-->
...
<!-- Da die Löschung von eigenen Projekten wie dem ReadMe Tut möglich sein sollte, hier nochmal den Weg zum Löschen aufzeigen.  Wenn du es mal Testen willst, wie es aus Studi-Perspektive aussieht, kannst du immer den Account "JK" impersonaten-->
