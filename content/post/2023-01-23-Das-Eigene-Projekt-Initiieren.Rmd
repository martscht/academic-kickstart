...
#### Das Projekt euerer Gruppe zuordnen

Jetzt müsst ihr unter dem Punkt **Project URL** bei "Pick a group or namespace" eure Gruppe suchen. 

![](/post/gitlaborientierung_pickgroup.png) 

Dieser Schritt ist sehr wichtig, da das Projekt auf jeden Fall zur richtigen Abteilung zugeordnet werden sollte!

##### Visibility-Levels

Nachdem ihr das Template ausgewählt habt, das auf euer Vorhaben am besten zutrifft, müsst ihr diesem einen Namen geben und das **Visibility-Level** anpassen. Durch Letzteres wird festgelegt, wer das Projekt und alle zugehörigen Dateien sehen kann. Hier gibt es drei Optionen, die erklärt werden. Ihr wählt als Standard-Option immer **internal**. 

<details><summary> **Private** </summary>

Wenn ihr diese Option auswählt, können nur die Mitglieder der Gruppe, der das Projekt zugeordnet ist, auf dieses zugreifen. Diese Option sollt ihr für Projekte in einer Gruppe oder Abteilung nicht auswählen. Sie steht nur der Vollständigkeit halber hier. 
...
Falls ihr sehr vertrauliche Daten habt, und zweifelt, ob diese Option die richtige ist, schaut [hier](#) nach. Dort wird erklärt, was ihr tun solltet, falls dieser Fall auf euch zutreffen sollte. 
...
![](/post/gitlaborientierung_warningFileAlreadyExists.png)

##### Dateien bearbeiten

Wie ihr evtl. schon gemerkt habt, ist nach der Projekt Initiierung neben den ganzen Ordnern auch schon eine Datei eurem Projekt hinzugefügt - das "README.md". 
...
![](/post/gitlaborientierung_readmeWebIDE.png)

Jetzt öffnet sich die Web IDE und ihr habt die Möglichkeit das "README.md" zu bearbeiten. Aber wie ihr sehen könnt, ist es nicht einfach nur eine Textdatei. Das "README.md" ist in der Sprache Markdown geschrieben - deswegen auch ".md". Lasst euch davon nicht verunsichern! Eine Anleitung zu Markdown findet ihr in diesem Tutorial etwas weiter [unten](#basic-markdown-tutorial) und ihr könnt eure Markdown Fähigkeiten auch in einer [Übung](https://pandar.netlify.app/post/lifos-r-markdown-uebung/) unter Beweis stellen.

<!--  Kann ich auch bei Word-Dateien auf die alte Version zugreifen? Ja, solange sie in dem Repository getracked sind, also entweder direkt auf GitLab bearbeitet wurden und die neue Version durch einen Commit hinzugefügt wurde ODER wenn man SmartGit hat und dann eben auch einen entsprechenden Ordner auf dem PC hat, der getracked wird. Oder man lädt die Datei halt immmer herunter und bearbeitet sie auf dem PC, lädt sie wieder hoch als neue Datei. Da man hier auch eine Commit-Message angeben muss, kann man anhand den Commits auf die alte Version zugreifen.  -->
...
Ihr könnt natürlich auch eigene [Anker](#anchor-point) setzen, indem ihr den HTML-Tag "<a>" mit einem Namens-Attribut (z.B. "anchor-point") benutzt.
