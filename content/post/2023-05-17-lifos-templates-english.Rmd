...
<!-- Erste Ebene -->
<form>
  <div class="row" id="divStart" style="display: block">
  Do you collect new data for your study or do you use preexisiting data?
  ...
  <!-- Zweite Ebene -->
  <!-- Neue Daten -->
  <div class="row" id="divNewData" style="display: none">
  ...
  <!-- Vorhandene Daten -->
  <div class="row" id="divOldData" style="display: none">
  ...
  <!-- Replikationsstudie -->
  <div class="row" id="divReplikation" style="display: none">
Your answers hint toward your study being a replication study. The following template is available for this type:
  
  - Replication Studies
  
In the recommended template your can find the Replication Recipe Preregistration Template by <a href="https://doi.org/10.1016/j.jesp.2013.10.005">Brandt et al. (2013)</a>, which is optimally suited to replications.
...
Did an error occur?<input type ="reset" value="Click here" onClick="Hide('divOldData', this); Hide('divNewData', this); Hide('divReplikation', this); Hide('divKeineReplikation', this); Hide('divMetaanalyse', this); Hide('divSekundaeranalyse', this); Hide('divExperiment', this); Hide('divDeskriptiveStudien', this); Hide('divHoppla', this)"/>to reset!
  ...
  <div class="row" id="divKeineReplikation" style="display: none">
Does your study perform aimed changes or manipulations on one or multiple independent variables to research their impact on a dependent variable or should only correlations between variables be described?
  ...
  <!-- Meta-Analysen -->
  <div class="row" id="divMetaanalyse" style="display: none">
Your answers hint toward your study being a meta-analysis or systematic review. The following template is available for this type:
...
Did an error occur?<input type ="reset" value="Click here" onClick="Hide('divOldData', this); Hide('divNewData', this); Hide('divReplikation', this); Hide('divKeineReplikation', this); Hide('divMetaanalyse', this); Hide('divSekundaeranalyse', this); Hide('divExperiment', this); Hide('divDeskriptiveStudien', this); Hide('divHoppla', this)"/>to reset!
  ...
  <!-- Sekundäranalyse -->
  <div class="row" id="divSekundaeranalyse" style="display: none">
Your answers hint toward your study being a secondary data analysis. The following template is available for this type:
  
  - Secondary Data Analaysis
  
In the recommended Template you can find a specific template for preregistration with a focus on secondary data analysis. Past that there will be no folder for the data and there are specific pointers in the ReadMe for what to keep in mind during a secondary data analysis.
...
Did an error occur?<input type ="reset" value="Click here" onClick="Hide('divOldData', this); Hide('divNewData', this); Hide('divReplikation', this); Hide('divKeineReplikation', this); Hide('divMetaanalyse', this); Hide('divSekundaeranalyse', this); Hide('divExperiment', this); Hide('divDeskriptiveStudien', this); Hide('divHoppla', this)"/>to reset!
  ...
  <!-- Experiment -->
  <div class="row" id="divExperiment" style="display: none">
...
Both templates are optimally suited for use in a study with a behavioral experiment and are diffent from eachother in regards to their preregistration templates.  The BSc template only includes the ASPrecited preregistration template, whereas  the MSc template includes three preregistration templates: AsPredicted, OSF Standard Preregistration Template, and the PRP-QUANT template - with the latter two being more detailed. For students, no matter if BSc or MSC, who chose together with their instructor to use the OSF Preregistration template, it is recommended to use the Behavioral Experiments MSc template.
  
Did an error occur?<input type ="reset" value="Click here" onClick="Hide('divOldData', this); Hide('divNewData', this); Hide('divReplikation', this); Hide('divKeineReplikation', this); Hide('divMetaanalyse', this); Hide('divSekundaeranalyse', this); Hide('divExperiment', this); Hide('divDeskriptiveStudien', this); Hide('divHoppla', this)"/>to reset!
  </div>
  
  <!-- Deskriptive Studien -->
  <div class="row" id="divDeskriptiveStudien" style="display: none">
Within your study you research existing correlatins without the use of an active experimental manipulation. The following two templates are available for this case:
...
Did an error occur?<input type ="reset" value="Click here" onClick="Hide('divOldData', this); Hide('divNewData', this); Hide('divReplikation', this); Hide('divKeineReplikation', this); Hide('divMetaanalyse', this); Hide('divSekundaeranalyse', this); Hide('divExperiment', this); Hide('divDeskriptiveStudien', this); Hide('divHoppla', this)"/>to reset!
  ...
  <div class="row" id="divHoppla" style="display: none">
