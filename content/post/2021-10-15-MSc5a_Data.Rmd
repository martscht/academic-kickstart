...
Goldberg, S. B., Rousmaniere, T., Miller, S. D., Whipple, J., Nielsen, S. L., Hoyt, W. T., & Wampold, B. E. (2016). Do psychotherapists improve with time and experience? A longitudinal analysis of outcomes in a clinical setting. *Journal of counseling psychology, 63*, 1-11. URL: [https://www.apa.org/pubs/journals/features/cou-cou0000131.pdf](https://www.apa.org/pubs/journals/features/cou-cou0000131.pdf)



## Block 4: Metaanalysen {#Block4}

Im `R`-Teil des Quizzes führen Sie Analysen am Datensatz der 2. Sitzung durch. Diesen erweitern Sie um die Reliabilitäten, um eine psychometrische Metaanalyse durchzuführen. Den Datensatz von Molloy et al. (2014) erhalten Sie mit dem Laden des `metafor`-Pakets:
...
Den Datensatz `dat.molloy2014` sollen Sie zunächst um die Reliabilitäten erweitern. Dazu müssen Sie die Reliabilitäten als Datensatz laden:
...
Die Datensätze können bspw. so zusammengefügt werden:
...
Um noch ein besseres Gefühl für Metaanalysen zu bekommen und um mal eine Studie zu betrachten, die nicht auch bereits im `metafor`-Paket integriert ist, sollen Sie sich für den inhallichen Part des Quizzes mit dem Artikel von 

[Vahedi, Z., & Zannella, L. (2021).](https://hds.hebis.de/ubffm/EBSCO/Record?id=edsbas.FE6E6149|edsbas) The association between self-reported depressive symptoms and the use of social networking sites (SNS): A meta-analysis. Current Psychology: A Journal for Diverse Perspectives on Diverse Psychological Issues, 40(5), 2174–2189. [https://doi.org/10.1007/s12144-019-0150-6](https://doi.org/10.1007/s12144-019-0150-6)

Laden Sie sich diese Metaanalyse herunter, um die Fragen zu beantworten. Die sozialen Netzwerke wurden mit SNS abgekürzt, was für Social Networking Sites steht.
