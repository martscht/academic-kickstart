...
Mit größerer Stichprobe wird die Power steigen (siehe dazu im Kapitel [Power-Plots](#PowerPlots) nach).

Die Power für den Korrelationstest zu bestimmt, ist als Übung bestimmt!
...
Genauso könnten wir uns fragen, wie groß ein Effekt sein muss, damit mit der vorliegenden Stichprobengröße und mit hinreichend großer Wahrscheinlichkeit ein signifikantes Ergebnis gefunden wird. Dies schauen Sie sich ebenfalls als Übung an!
...
```
Die Power liegt bei 0.3379, also bei 33.79%. Sie ist damit also gar nicht so verschieden zu unserer geschätzten Power von `r round(mean(pt_H1_0.5 < 0.05)*100,2)`%. Mehr Informationen zum `pwr`-Paket finden sie [hier](https://www.statmethods.net/stats/power.html).
