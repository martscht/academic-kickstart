...
Eine Wiederholung der Regressionsanalyse (und der Korrelation) finden Sie bspw. in [Eid, Gollwitzer und Schmitt  (2017)](https://hds.hebis.de/ubffm/Record/HEB366849158) Kapitel 16 bis 19 und [Pituch und Stevens (2016)](https://hds.hebis.de/ubffm/Record/HEB371183324) in Kapitel 3.
...
### Blasendiagramm
Die Funktion `influencePlot` des `car`-Paketes erzeugt ein "Blasendiagramm" zur simultanen grafischen Darstellung von Hebelwerten (auf der x-Achse), studentisierten Residuen (auf der y-Achse) und Cook's Distanz (als Größe der Blasen). Das studentisierte Residuum ist dabei eine Möglichkeit, die Residuen-Werte unseres Modells zu normieren. Vertikale Bezugslinien markieren das Doppelte und Dreifache des durchschnittlichen Hebelwertes, horizontale Bezugslinien die Werte -2, 0 und 2 auf der Skala der studentisierten Residuen. Vertikale Linien verdeutlichen die Grenzen, die für die Hebelwerte festgelegt werden (sind analog zu unseren rot und blau gezeichneten im Histogramm).   
