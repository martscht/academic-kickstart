...
#### Modellvergleich
Diesen kennen wir bereits aus der [hierarchischen Regressionssitzung](/post/multi-level-modeling). Da wir hier keine Varianzen prüfen, können wir die $p$-Werte so interpretieren, wie sie ausgegeben werden.
