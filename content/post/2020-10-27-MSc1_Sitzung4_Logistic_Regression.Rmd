...
#### Modellvergleich
Diesen kennen wir bereits aus der [hierarchischen Regressionssitzung](/post/multi-level-modeling). Allerdings haben wir es hier nicht mit *restricted* Likelihoods zu tun, weswegen wir das `refit` Argument weglassen können! Auch prüfen wir hier keine Varianzen, sodass wir die $p$-Werte interpretieren können, so wie sie ausgegeben werden.
