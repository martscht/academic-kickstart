...
Eine Schreibweise für die normale Regression ist $\mathbb{E}[Y | X_1 = x_1,\dots]=\beta_0 + \beta_1x_1 + \dots$. Gilt für $Y=0,1$, so ist $\mathbb{E}[Y] = \mathbb{P}(Y=1)=p$, also der Mittelwert über $Y$ ist die Wahrscheinlichkeit, dass $Y=1$ (wie wir oben am Münzwurfbeispiel gesehen haben). Somit ist ersichtlich, dass bei der logistischen Regression im Grunde nichts anderes als der Mittelwert/die Erwartung, dass $Y=1$ ist, modelliert wird. 
