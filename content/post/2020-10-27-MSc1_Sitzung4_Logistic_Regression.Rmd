...
## Modellspezifikation
Um das Überleben zu modellieren, könnten wir eine [Regressionsanalyse](/post/regression-und-ausreisserdiagnostik) heranziehen und das Überleben (`survived`) durch bspw. das Alter (`age`) vorhersagen:
