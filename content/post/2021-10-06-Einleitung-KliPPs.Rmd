...
Therapy[5, 6] <- "männlich"    # Aktuellen Inhalt überschreiben
...
Der Output enthält nun verschiedene Informationen. Natürlich wird der Testwert, die Freiheitsgrade und der p-Wert ausgegeben. auch die empirischen Mittelwerte in den Gruppen werden nochmal aufgeführt. Das Ergebnis spricht dafür, dass zwischen den beiden Gruppen ein signifikanter Unterschied besteht - die $H_1$ also angenommen wird.

Nun sind wir am Schluss des behandelten Codes in der Seminar-Sitzung angekommen. Die Grundlagen von `R` und einigen statistischen Verfahren sind nun aufgefrischt. Es folgt noch ein Zusatz für interessierte Personen.
