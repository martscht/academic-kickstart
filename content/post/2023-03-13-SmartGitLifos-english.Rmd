---
title: SmartGit and LIFOS
date: '2023-02-23'
slug: smartgitlifos-eng
categories:
  - "lifos"
tags: []
subtitle: ''
...
<span style="color: darkred;">**SmartGit**</span> is a graphical interface for using <span style="color: darkred;">**Git**</span> services on your local computer - you can even connect them with remote repositories. The programm exists since 2009 and has always been developed further, which ensures smooth functioning. But what use is <span style="color: darkred;">**SmartGit**</span> to you in connection with LIFOS?

# Why you should use <span style="color: darkred;">**SmartGit**</span> ? 

<span style="color: darkred;">SmartGit</span> allows you to have a "repository" locally on your computer. A "repository" is a folder in which a "copy" of your project is stored on LIFOS. "Copy" is in quotation marks because this folder is tracked by <span style="color: darkred;">SmartGit</span>, which means that any changes made in this folder can be tracked using <span style="color: darkred;">SmartGit</span>. This means that if a change is made online on LIFOS, you can also see it in your local folder, and vice versa. This makes everything much more traceable, especially when working on a group project. You will learn how to install and use <span style="color: darkred;">SmartGit</span> on your computer in the following sections.
...
In the settings for <span style="color: darkred;">SmartGit</span>, you need to agree to the terms of use and select "Non-commercial use only" under License type if you are using the program for scientific purposes, so that you do not have to pay for its use.


![](/post/smartgit_license.png)

This needs to be confirmed again in a second window. Next, under *User Information*, you need to give yourself a username and provide an email address through which you can configure your <span style="color: darkred;">SmartGit</span>. For simplicity, you can use the same username and email that are used for LIFOS. 
...
For this, we need your username, password, and the HTTPS link to your project. You can find the link by going to your project, clicking on *Clone*, and then copying the link under *Clone with HTTPS*.

![](/post/smartgitlifos_httpsLink.png)
You will find the username you need on the top right, with a click on your avatar. The username begins with an "@".

![](/post/smartgitlifos_username.png)

Now we switch to <span style="color: darkred;">**SmartGit**</span> again. Here we click on *Clone* under *Repository*. 

![](/post/smartgitlifos_RepositoryClone.png)

Insert the link, you have copied, under "Repository URL" and then click *Next*. 

![](/post/smartgitlifos_RepositoryInitiate.png)
On the following page, we accept the default settings and click on *Next* again.

![](/post/smartgitlifos_RepositoryInitiate2.png)
...
![](/post/smartgitlifos_NewRepository.png)
...
To learn more about <span style="color: darkred;">Git</span> and all the related commands and actions, check out [this](https://pandar.netlify.app/post/gitintro#basics) tutorial.
...
![](/post/smartgitlifos_RepositoryData.png)
...
![](/post/smartgitlifos_RepositoryChangeREADME.png)
...
![](/post/smartgitlifos_ModifiedREADME.png)
...
![](/post/smartgitlifos_Commit2.png)
...
![](/post/smartgitlifos_CommitMessage.png)
...
![](/post/smartgitlifos_push.png)

Since we are now letting <span style="color: darkred;">SmartGit</span> interact with a server for the first time, we will be asked for a **Master Password**. You can skip this, but it is important for protecting passwords in the interaction with servers, which is why we strongly recommend setting one up. It's best not to use the same password you use for the LIFOS server.
...
![](/post/smartgitlifos_WebIDEChangeFile.png)

Then we click on `Commit`. 

![](/post/smartgitlifos_WebIDECommitFile.png)
...
![](/post/smartgitlifos_WebIDECommitMessage.png)
...
![](/post/smartgitlifos_DifferentCommit.png)
...
<span style="color: darkred;">SmartGit</span> greatly facilitates collaboration on a project and offers a well-designed user interface. We have learned some additional commands that enable us to work effectively on shared projects. If you are interested in learning more about <span style="color: darkred;">SmartGit</span> and <span style="color: darkred;">Git</span>, you can check out the other tutorials on these topics on pandaR.
