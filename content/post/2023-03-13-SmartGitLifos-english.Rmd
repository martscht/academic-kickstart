...
<span style="color: darkred;">SmartGit</span> greatly facilitates collaboration on a project and offers a well-designed user interface. We have learned some additional commands that enable us to work effectively on shared projects. If you are interested in learning more about <span style="color: darkred;">SmartGit</span> and <span style="color: darkred;">Git</span>, you can check out the other tutorials on these topics on [pandaR](/extras/#git).
