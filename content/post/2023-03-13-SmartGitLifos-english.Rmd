...
![](/post/smartgitlifos_warning.png)

Only the lower warning is of interest to us right now. Click on *set a password*. You should get redirected to a page to create a new password. This password will be used to connect SmartGit with your project. It is not used to log in on Gitlab itself, you will still need to use your HRZ-login credentials for that.
