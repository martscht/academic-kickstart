...
| ----- | --- |
| [Achtsamkeit und Depression](#achtsamkeit-und-depression-raw_data) |  [`r fontawesome::fa('download')` OSF ](https://osf.io/awz3d/download) |
| [Alkoholkonsum von Jugendlichen](#alkoholkonsum-von-jugendlichen-alc) | [`r fontawesome::fa('download')` `alc` ](/post/alc.rda) |
[Arbeitsstress bei Call-Center-Mitarbeiter:innen](#arbeitsstress-bei-call-center-mitarbeiterinnen-stressatwork) | [`r fontawesome::fa('download')` `StressAtWork` ](/post/StressAtWork.rda) |
| [Vergleich von Behandlungsformen](#vergleich-von-behandlungsformen-behandlungsform) | [`r fontawesome::fa('download')` `Behandlungsform` ](post/Behandlungsform.rda)
| [Die Big Five Persönlichkeitsdimensionen](#die-big-five-persönlichkeitsdimensionen-big5) | [`r fontawesome::fa('download')` `Big5` ](/post/Big5_EFA.rda) |
| [Interozeptive Aufmerksamkeit und Genauigkeit](#interozeptive-aufmerksamkeit-und-genauigkeit-body) | [`r fontawesome::fa('download')` OSF ](https://osf.io/j6ef3/download) |
| [Bildungsinvestitionen auf der Welt](#bildungsinvestitionen-auf-der-welt-edu_exp) | [`r fontawesome::fa('download')` `edu_exp` ](/post/edu_exp.rda) 
| [Bullyingprävention bei Jugendlichen](#bullyingprävention-bei-jugendlichen-fairplayer) | [`r fontawesome::fa('download')` `fairplayer` ](/post/faiplayer.rda) |
| [Quasi-Experimentelle Therapiestudie](#quasi-experimentelle-therapiestudie-cbtdata) | [`r fontawesome::fa('download')` `CBTdata` ](/post/CBTdata.rda) |
| [Depressivität](#depressivitat-Depression) | [`r fontawesome::fa('download')` `Depression` ](/post/Depression.rda) |
| [Effektivität der CBT bei Depression](#effektivität-der-cbt-bei-depression-f2f_cbt) | _Teil des Pakets `metafor`_ |
|  [Entwicklung der Weltbevölkerung](#entwicklung-der-weltbevölkerung-worldpopulation) | [`r fontawesome::fa('download')` `WorldPopulation` ](/post/WorldPopulation.rda) |
| [Fragebogendaten aus dem ersten Semester](#fragebogendaten-aus-dem-ersten-semester-fb21) |  [`r fontawesome::fa('download')` `fb21` ](/post/fb21.rda) |
| [Gender, Drug, and Depression](#gender-drug-and-depression-osf) | [`r fontawesome::fa('download')` OSF ](https://osf.io/prc92/download) |
| [Skalenwerte der Generic Conspiracist Beliefs Scale](#skalenwerte-der-generic-conspiracist-beliefs-scale-conspiracy) | [`r fontawesome::fa('download')` `conspiracy` ](/post/conspiracy.rda) |
| [Items der Generic Conspiracist Beliefs Scale](#items-der-generic-conspiracist-beliefs-scale-conspiracy_cfa)) | [`r fontawesome::fa('download')` `conspiracy_cfa` ](/post/conspiracy_cfa.rda) |
...
| [Internetintervention für psychische Störungen](#internetintervention-für-psychische-störungen-osf) | [`r fontawesome::fa('download')` OSF ](https://osf.io/zc8ut/download) |
...
| [Machiavellismus-Fragebogen](#machiavellismus-fragebogen-mach) | [`r fontawesome::fa('download')` `mach` ](/post/mach.rda) |
| [Major Depression](#major-depression-data) | [`r fontawesome::fa('download')` OSF ](https://osf.io/g6ya4/download) |
| [Mehrdimensionaler Befindlichkeitsfragebogen](#mehrdimensionaler-befindlichkeitsfragebogen-mdbf) | [`r fontawesome::fa('download')` `mdbf` ](/post/mdbf.rda) |
| [Mental Health and Social Contact During the COVID-19 Pandemic](#mental-health-and-social-contact-during-the-covid-19-pandemic-data) | [`r fontawesome::fa('download')` OSF ](https://osf.io/qev5n/download) |
| [Naturverbundenheit](#naturverbundenheit-nature) | [`r fontawesome::fa('download')` `nature` ](/post/nature.rda) |
| [Lesekompetenz in der PISA-Erhebung](#lesekompetenz-in-der-pisa-erhebung-pisa2009) | [`r fontawesome::fa('download')` `PISA2009` ](/post/PISA2009.rda) |
| [Parental Burnout](#parental-burnout-burnout) | [`r fontawesome::fa('download')` OSF ](https://osf.io/qev5n/download) |
| [Hauptkomponentenanalyse](#hauptkomponentenanalyse-pca) | [`r fontawesome::fa('download')` `PCA` ](/post/PCA.RData) |
| [Psychisches Wohlbefinden von Individuen während des Lockdowns in Frankreich](#psychisches-wohlbefinden-von-individuen-während-des-lockdowns-in-frankreich-lockdown) | [`r fontawesome::fa('download')` OSF ](https://osf.io/dc6me/download)
| [Kulturelle Unterschiede in Korruptionsbestrafung](#kulturelle-unterschiede-in-korruptionsbestrafung-punish) | [`r fontawesome::fa('download')` OSF ](https://osf.io/4wypx/download)
| [Schulleistungen](#schulleistungen) | [`r fontawesome::fa('download')` `Schulleistungen` ](/post/Schulleistungen.rda) |
| [Therapieerfolg](#therapieerfolg-therapy) | [`r fontawesome::fa('download')` `Therapy` ](/post/Therapy.rda) |
| [Titanic](#titanic) |  [`r fontawesome::fa('download')` `Titanic` ](/post/Titanic.rda) |
| [Traumatische Erlebnisse und psychische Störungen](#traumatische-erlebnisse-und-psychische-störungen-trauma) | [`r fontawesome::fa('download')` OSF ](https://osf.io/a9vun/download) |
...
## Fragebogendaten aus dem ersten Semester `fb21`
...
Die Daten können direkt vom [`r fontawesome::fa('download')` OSF heruntergeladen ](https://osf.io/4wypx/download) werden. Allerdings werden einige Schritte durchlaufe, um die Daten auf die nötigen Variablen zu reduzieren, welche mit 

```{r}
source(url("https://pandar.netlify.app/post/Preprocessing/Data_Processing_punish.R"))
```
