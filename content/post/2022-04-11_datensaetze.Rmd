...
| [Quasi-Experimentelle Therapiestudie](#quasi-experimentelle-therapiestudie-cbtdata) | [`r fontawesome::fa('download')` `fairplayer` ](/post/CBTdata.rda) |
| [Depressivität](#depressivität-Depression) | [`r fontawesome::fa('download')` `Depression` ](/post/Depression.rda) |
...
| [Gender, Drug, and Depression](#gender-drug-and-depression-osf) | [`r fontawesome::fa('download')` `fb21` ](https://osf.io/prc92/download) |
...
Auf `pandaR` wird der Datensatz in dem [Quiz 5](/post/bsc7-daten/#Quiz5) für PsyBsc2 und in [Block 1](/post/msc5a-daten/#Block1) der Quizze für PsyMSc5a verwendet.
