...
Wir sehen allerdings, dass jedoch Patient:innen mit Angststörung in der Therapiegruppe überrepräsentiert sind ($\chi^2(1)=$ `r round(chisq.test(table(CBTdata$Treatment, CBTdata$Disorder))$statistic, 2)`,  $p<0.05$):
...
## R-Skript
Den gesamten `R`-Code, der in dieser Sitzung genutzt wird, können Sie [`r fontawesome::fa("download")` hier herunterladen](/post/KliPPs_MSc5a_R_Files/9_kausalschaetzer_RCode.R).
