...
# Speichern des PS und Transformation in Wahrscheinlichkeiten
...
## Effekt der Gewichtung
# Ungewichtete Häufigkeiten
table(df.full$Treatment, df.full$subclass)
# Gewichtete Häufigkeiten
round(wtd.table(y = df.full$subclass, x = df.full$Treatment, weights = df.full$weights), 3)
