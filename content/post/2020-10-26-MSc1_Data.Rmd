...
Sie können den   [`r fontawesome::fa("download")` Datensatz "Xmas.rda" hier herunterladen](/post/Xmas.rda) und diesen anschließend mit `load` laden (bspw. auf dem Desktop von Frau "Musterfrau").
...
Sie können den gekürzten  [`r fontawesome::fa("download")` Datensatz "Big5.rda" hier herunterladen](/post/Big5.rda) und diesen anschließend mit `load` laden (bspw. auf dem Desktop von Frau "Musterfrau").
