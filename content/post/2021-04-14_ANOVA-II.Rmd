...
So ein `aov`-Objekt hat auch weitere Vorteile, da wir bspw. dem `ez1` Objekt nicht direkt die Fehlerquadratsumme entlocken können, welche bspw. dafür benötigt werden, um $\eta^2$ zu bestimmen. Um einem `aov`-Objekt ähnliche Infos zu entlocken, wird in der Regel die `summary` Funktion verwendet.
